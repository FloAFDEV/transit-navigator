        ...
        <div className="rounded-md border border-border bg-card p-4">
          ...
          {showDiagnostic && (
            <div className="mt-3 space-y-2 text-[10px]">
              ...
              {connectivity.geoInferredEdges > 0 && (
                <div className="text-[10px] text-muted-foreground/70 bg-amber-500/10 border border-amber-500/20 rounded p-1.5">
                  <span className="text-amber-600 dark:text-amber-400 font-medium">{connectivity.geoInferredEdges}</span>
                  {' '}connexion{connectivity.geoInferredEdges > 1 ? 's' : ''} inférée{connectivity.geoInferredEdges > 1 ? 's' : ''} géographiquement (≤150m) — absentes du GTFS
                </div>
              )}
